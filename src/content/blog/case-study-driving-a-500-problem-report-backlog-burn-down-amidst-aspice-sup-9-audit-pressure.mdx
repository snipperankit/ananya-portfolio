...
blocks:
  ...
  - type: text
    text: >-
      - **Root Cause Analysis and Brainstorming** Strategy brainstorming is not
      possible without first understanding the root causes behind the issues
      faced. A two-tier diagnostic strategy was executed:
