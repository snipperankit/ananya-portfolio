...
blocks:
  ...
  - type: text
    text: >-
      The seven separate branches are:


      - **Team Mindset and Culture**: This branch describes alignment issues and a disconnect between management expectations and team capacity. Overwhelmed by heavy workloads, the team prioritises easy fixes over complex tasks and views pull requests or management metrics as distractions rather than collective goals. As a result, there is fragmented ownership, where tickets are deflected and sprint focuses are misaligned with respect to urgency.

      - **Process and Methods:** This branch describes the Jira tool fatigue and the feeling of being process-heavy amidst a growing backlog. There are also inconsistent problem report templates between internal and Customer tickets. Aside from this, poor meeting follow-through is another facet.

      - **People and Skills:** There are knowledge silos as well as uneven expertise, which create dependency bottlenecks. Another root cause was the recent handover of the project to a different geographic location. As specialists are shared among projects, they create bottlenecks due to their unavailability.

      - **Dependencies:** Cross-ART dependencies and Integration merge strategies for quality topics slow down ticket closure. A lot of time is also spent clarifying ownership within other ARTs.

      - **Tools and Environments:** This branch considers license renewal and setup delays in test bench setups. Additionally, certain tickets that require verification directly on the vehicle are dependent on vehicle availability.

      - **Clarity and Requirements:** Poor documentation and fragmented information cause constant rework. Requirement clarifications are not documented centrally as a single source of truth before they are recorded in the requirements management system.

      - **External factors:** This branch discusses how milestone pressure and growing inflow make complex investigations harder to resume. Continuous Test Plan updates due to new feature implementations and hardware add more inflow to the backlog.
      ...
      Each action item is assigned to primary owners within the team to ensure these points are successfully realised to completion. Close to 15 strong actions focused on resolving each of the root-cause branches are derived. The table summarises each of the action points that were brainstormed.
  - type: image
  ...
  - type: text
    text: >-
      ...
      **➡️ BP5 - Track Problem Resolution to Closure**
      ...
      - **Clear Definition of Ready and Clear Definition of Done:** Tracking compliance with strict entry and exit criteria
